...
export const Search = () => {
  ...
  return (
    ...
    <button className="flex items-center gap-2 group hover:text-accent500" onClick={ handleOpenSearch }>
      ...
      <span className="hidden sm:block">Cercare</span>
    </button>
    <div className={`${ openSearch ? "visible opacity-100" : "invisible opacity-0" } transition-all duration-500 ease-in-out flex fixed top-0 left-0 z-[999] w-full h-dvh items-center justify-center p-6 md:p-8`}>
      ...
      <div className="relative z-20 w-[520px] max-w-full">
        <div>
          <svg viewBox="0 0 32 32" className="fill-white absolute left-6 top-[22px] z-20" width="20">
            <path d="M31.4,28.6l-6.2-6.2c4.6-6.2,3.4-15-2.8-19.6C16.2-1.8,7.4-.6,2.8,5.6-1.8,11.8-.6,20.6,5.6,25.2c5,3.7,11.8,3.7,16.8,0l6.2,6.2c.8.8,2,.8,2.8,0,.8-.8.8-2,0-2.8h0ZM14.1,24c-5.5,0-10-4.5-10-10S8.6,4.1,14.1,4.1s10,4.5,10,10c0,5.5-4.5,10-10,10Z"/>
          </svg>
          <input
            ref={inputRef}
